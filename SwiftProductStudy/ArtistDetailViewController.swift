//
//  ArtisDetailViewController.swift
//  SwiftProductStudy
//
...
extension ArtistDetailViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! WorkTablelViewCell
        ...
        cell.workTitleLabel.textColor = UIColor(white: 114/255, alpha: 1)
...
extension ArtistDetailViewController: UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        guard let cell = tableView.cellForRow(at: indexPath) as? WorkTablelViewCell else { return }
