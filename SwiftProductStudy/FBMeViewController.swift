...
class FBMeViewController: FBBaseViewController {
    ...
    fileprivate var user: FBMeUser {
        get {
            return FBMeUser(name: "BayMax", avatarName: "BayMax", education: "CMU")
        }
    }
    ...
    private let tableView: UITableView = {
        ...
        view.register(FBMeBaseCell.self, forCellReuseIdentifier: FBMeBaseCell.identifer)
        return view
    }()
...
extension FBMeViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if title == user.name {
            ...
            cell = tableView.dequeueReusableCell(withIdentifier: FBMeBaseCell.identifer, for: indexPath)
        }
